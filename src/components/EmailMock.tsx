...
export default function EmailMock() {
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-border-light max-w-sm w-full overflow-hidden">
      {/* Email client header */}
      <div className="bg-bg-subtle px-4 py-2.5 border-b border-border-light flex items-center gap-2">
        <Mail className="w-4 h-4 text-text-muted-dark" />
        <span className="text-xs font-medium text-text-dark">Inbox</span>
        <span className="ml-auto text-[10px] text-text-muted-dark">2 messages</span>
      </div>
      ...
      <div className="px-4 py-3 border-b border-border-light">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[11px] font-semibold text-text-dark truncate">
              sarah.nkosi@gmail.com
            </p>
            <p className="text-[10px] text-text-muted-dark truncate">
              To: info@sparkelectrical.co.za
            </p>
          </div>
        </div>
        <p className="text-xs font-semibold text-text-dark mb-1.5">
          Need an electrician for DB board
        </p>
        <p className="text-[11px] text-text-muted-dark leading-relaxed">
      ...
      <div className="px-4 py-3 bg-accent/5">
        ...
        <div className="text-[11px] text-text-dark leading-relaxed space-y-2">
          <p>Hi Sarah,</p>
          <p>
          ...
          <ul className="list-disc list-inside text-text-muted-dark space-y-0.5 ml-1">
