...
export default function DigitalAssistantHero() {
  return (
    <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 grain overflow-hidden">
      ...
      <div className="relative mx-auto max-w-site px-6 lg:px-10">
        <p className="eyebrow text-ember mb-6">Service 1, inbound</p>
        <h1 className="display-xl text-ink max-w-[22ch]">
          The digital assistant that turns website visitors into{" "}
          <em className="italic font-light">paying jobs.</em>
        </h1>
        <p className="mt-8 text-lg text-ink-700 max-w-2xl leading-relaxed">
          Every enquiry that lands on your site is captured, qualified, and pinged to your phone in under 60 seconds. Built for SA service businesses.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          ...
          <CTAButton href="/watch" variant="outline" size="lg" withArrow={false}>
