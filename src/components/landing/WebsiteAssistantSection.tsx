        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-10 pt-8 border-t border-paper/10 flex items-center gap-3 flex-wrap">
              <p className="text-paper/40 text-xs eyebrow mr-2">Leads delivered to</p>
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-ember/10 border border-ember/20">
                ...
                <span className="text-[11px] font-semibold text-ember">Your inbox</span>
              </div>
              <span className="text-paper/40 text-xs">Every qualified lead, every time.</span>
            </div>
          </div>
