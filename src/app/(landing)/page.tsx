...
const teaserTiers = [
  {
    ...
    price: "R699",
    period: "/month",
    tagline: "Solos and sole practitioners",
    highlight: false,
    isTrial: false,
    features: [
  ...
  },
  {
    ...
    price: "R3,999",
    period: "/month",
    tagline: "Multi-doctor, multi-agent practices",
    highlight: false,
    isTrial: false,
    features: [
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        priceCurrency: "ZAR",
        price: "7999",
        description: "1,500+ qualified leads per month. White-label, API access, dedicated support with 1h SLA. From R7,999 per month, custom volume pricing.",
        url: "https://www.qwikly.co.za/pricing",
        availability: "https://schema.org/InStock",
      },
    ],
