  ...
  offers: [
    {
      ...
      priceCurrency: "ZAR",
      price: "0",
      priceSpecification: { "@type": "UnitPriceSpecification", billingDuration: "P14D" },
      description: "14-day free trial of the Qwikly digital assistant platform. No card required.",
